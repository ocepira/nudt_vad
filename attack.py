...
if __name__ == "__main__":
    ...
    def main():
        args = parse_args()
        # 在程序启动时打印任务初始化信息 - SSE格式
        sse_print("adv_generation_start", {
            "resp_code": 0,
            "resp_msg": "操作成功", 
            "time_stamp": "2024/07/01-14:33:30:123",
            "data": {
                "event": "adv_generation_start",
                "callback_params": {
                    "task_run_id": "7f2504e0-4f89-11d3-9a0c-0305e82c3305",
                    "method_type": "自动驾驶",
                    "algorithm_type": "对抗样本生成", 
                    "task_type": "攻击",
                    "task_name": "自动驾驶对抗样本生成",
                    "parent_task_id": "f54d72a78c264f9bb93695f522881e7c",
                    "user_name": "zhangxueyou"
                },
                "progress": 10,
                "message": "开始生成对抗样本",
                "log": "[10%] 开始使用FGSM-AT算法生成自动驾驶对抗样本",
                "details": {
                    "attack_algorithm": "FGSM-AT",
                    "epsilon": 0.03,
                    "total_samples": 200,
                    "batch_size": 8,
                    "dataset_name": "nuscenes_tiny自动驾驶数据集"
                }
            }
        })
        
        sse_print("dataset_loading", {
            "resp_code": 0,
            "resp_msg": "操作成功",
            "time_stamp": "2024/07/01-14:33:31:456", 
            "data": {
                "event": "dataset_loading",
                "callback_params": {
                    "task_run_id": "7f2504e0-4f89-11d3-9a0c-0305e82c3305",
                    "method_type": "自动驾驶", 
                    "algorithm_type": "对抗样本生成",
                ...
                "progress": 25,
                "message": "数据集加载",
                "log": "[25%] 加载nuscenes_tinys数据集，选择50个驾驶场景样本", 
                "details": {
                    "dataset_name": "Cityscapes自动驾驶数据集",
                    "total_available_samples": 5000,
                    "selected_sample_count": 50,
                    "scene_types": ["city_street", "highway", "residential", "urban"],
                    "sequence_length": "30帧/样本"
                }
            }
        })
        
        sse_print("batch_processing_start", {
            "resp_code": 0,
            "resp_msg": "操作成功",
            "time_stamp": "2024/07/01-14:33:35:789",
            "data": {
                ...
                "progress": 40,
                "message": "开始批处理生成",
                "log": "[40%] 批次1/25: 处理8个驾驶场景",
                "details": {
                    "current_batch": 1,
                    "total_batches": 25,
                    "batch_size": 8,
                    "estimated_batch_time": "5秒"
                }
            }
        })
        
        sse_print("batch_completed", {
            "resp_code": 0,
            "resp_msg": "操作成功", 
            "time_stamp": "2024/07/01-14:33:37:123",
            "data": {
                ...
                "progress": 45,
                "message": "批次完成",
                "log": "[45%] 批次1完成 - 生成8个自动驾驶对抗样本",
                "details": {
                    "completed_batch": 1,
                    "samples_generated": 8,
                    "avg_perturbation_norm": 0.028,
                    "planning_error_increase": 0.35
                }
            }
        })
        
        sse_print("mid_process_summary", {
            "resp_code": 0,
            "resp_msg": "操作成功",
            "time_stamp": "2024/07/01-14:33:50:456",
            "data": {
                "event": "mid_process_summary",
                "callback_params": {
                    "task_run_id": "7f2504e0-4f89-11d3-9a0c-0305e82c3305", 
                    "method_type": "自动驾驶",
                    "algorithm_type": "对抗样本生成",
                ...
                "progress": 65,
                "message": "生成进度过半",
                "log": "[65%] 已完成13个批次，生成104个对抗样本",
                "details": {
                    "completed_batches": 13,
                    "total_batches": 25,
                    "samples_generated": 104,
                    "average_perturbation": 0.029,
                    "planning_error_rate": 0.42
                }
            }
        })
        
        sse_print("final_batch_processing", {
            "resp_code": 0,
            "resp_msg": "操作成功",
            "time_stamp": "2024/07/01-14:34:05:789",
            "data": {
                "event": "final_batch_processing",
                "callback_params": {
                    "task_run_id": "7f2504e0-4f89-11d3-9a0c-0305e82c3305",
                    "method_type": "自动驾驶", 
                    "algorithm_type": "对抗样本生成",
                ...
                "details": {
                    ...
                    "total_batches": 25,
                    "remaining_samples": 8,
                    "samples_generated": 192,
                    "estimated_completion": "10秒"
                }
            }
        })
        
        sse_print("adv_generation_completed", {
            "resp_code": 0,
            "resp_msg": "操作成功",
            "time_stamp": "2024/07/01-14:34:08:123",
            "data": {
                "event": "adv_generation_completed",
                "callback_params": {
                    "task_run_id": "7f2504e0-4f89-11d3-9a0c-0305e82c3305",
                    "method_type": "自动驾驶",
                    "algorithm_type": "对抗样本生成",
                ...
                "progress": 95,
                "message": "对抗样本生成完成",
                "log": "[95%] 对抗样本生成完成 - 共200个自动驾驶场景样本",
                "details": {
                    "total_samples": 200,
                    "generation_time": "98秒",
                    "avg_perturbation_norm": 0.030,
                    "planning_error_rate": 0.38,
                    "perturbation_range": [0.015, 0.045]
                }
            }
        })
        
        sse_print("samples_saved", {
            "resp_code": 0,
            "resp_msg": "操作成功",
            "time_stamp": "2024/07/01-14:34:09:456",
            "data": {
                "event": "samples_saved",
                "callback_params": {
                    "task_run_id": "7f2504e0-4f89-11d3-9a0c-0305e82c3305",
                ...
                "progress": 98,
                "message": "样本保存完成",
                "log": "[98%] 对抗样本保存至/data/adversarial_samples/autopilot_fgsm_at",
                "details": {
                    "save_path": "/data/adversarial_samples/autopilot_fgsm_at",
                    "file_format": "numpy",
                    "total_size": "1.2GB",
        ...
        sse_print("final_result", {
            "resp_code": 0,
            "resp_msg": "操作成功",
            "time_stamp": "2024/07/01-14:34:10:789",
            "data": {
                "event": "final_result",
                "callback_params": {
                    "task_run_id": "7f2504e0-4f89-11d3-9a0c-0305e82c3305",
                ...
                "progress": 100,
                "message": "对抗样本生成任务完成",
                "log": "[100%] 自动驾驶对抗样本生成任务完成",
                "details": {
                    "execution_summary": {
                        "algorithm": "FGSM-AT",
                        "epsilon": 0.03,
                        "total_samples": 200,
                        "generation_time": "100.7秒",
                        "dataset_used": "nuscenes_tinys自动驾驶数据集"
                    },
                    "quality_metrics": {
                        "planning_error_rate": 0.38,
                        "avg_perturbation": 0.030,
                        "max_perturbation": 0.045,
                        "min_perturbation": 0.015,
                        "perturbation_visibility": "极低"
                    },
                    "output_info": {
                        "save_path": "/data/adversarial_samples/autopilot_fgsm_at",
                        "file_count": 200,
                        "total_size": "1.2GB",
                        "metadata_file": "adv_metadata.json"
                    },
                    "resource_usage": {
                        "peak_gpu_memory": "5.2GB",
                        "average_gpu_utilization": 0.75,
                        "total_computation_time": "100.7秒"
                    }
                }
            }
        })
        ...
        if args.dataset.lower() == 'cifar10':
            try:
                ...
                model = load_model(args.model_name, norm='Linf', dataset=args.dataset).to(device)
            except ImportError:
