        ...
        data = {
                ...
                "data": {
                    ...
                    "details": {
                        ...
                        "ori_image": "output/ori_images/CAM_FRONT_PRED_id.png",
                        "attack_image": "output/atk_images/CAM_FRONT_PRED_ATTACK_id.png",
                        "attack_method": args.attack_method,
        ...
        sse_print("final_result", {
                ...
                "data": {
                    ...
                    "details": {
                        ...
                        "ori_images": {"message": f"防御后推理结果保存为: ./output/ori_images/CAM_FRONT_PRED_id.png"},
                        "defense_images": {"message": f"防御后推理结果保存为: ./output/def_images/CAM_FRONT_PRED_Defense_id.png"},
                        "summary":{
